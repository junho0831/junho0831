...
- **Backend & Data**: `Java` `Spring Boot` `JPA` `Python` `PostgreSQL` `MySQL` `Redis` `Elasticsearch`
- **Pipeline & DevOps**: `Airflow` `Docker` `GitLab CI/CD` `Nginx`
- **Realtime & AI**: `WebRTC` `LiveKit SFU` `LangChain` `RAG`
