...
- 반도체 비즈니스 로직 중심 **Spring Boot 기반 API 개발**
- Vue.js를 활용한 UI 개선 및 신규 기능 개발

### 투바 (2024.07 ~ 2024.12) — ERP 유지보수
- **멀티 파일 업로드 기능 구현**: 최대 10개 파일(50MB 이하) 업로드 안정성 확보
- **AtomicInteger 기반 고유 ID 생성** → DB Key 중복 문제 해결
- **PHP → Java 마이그레이션** → 프로젝트 일관성 및 타 시스템 연동 강화

### 헥토 (2023.10 ~ 2024.07) — AI/개발팀
- **KMS(지식관리시스템) 신규 API 개발**: 유저·그룹·권한 관리
- GitLab 기반 **CI/CD 파이프라인 구축**
- **스마트큐(인터뷰 시스템)**: OpenAI API + LangChain + RAG 기반 자연어 처리 기능 개발
- Docker, Streamlit, Poetry 기반 환경 세팅

### 헥토이노베이션 (2022.08 ~ 2023.09) — 마이데이터개발팀
- **LG PASS MONEY API 설계 및 구현**
- Admin 사용자 관리 페이지 개발
- 광고 배너 UI 작업
- **Crontab 정기 배치 작업 자동화** → 운영 안정성 확보
